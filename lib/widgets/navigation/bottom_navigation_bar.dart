...
class CustomNavigationBar extends StatelessWidget {
  ...
  CustomNavigationBar({super.key, required this.currentIndex, required this.onItemTapped});
  ...
  Widget _buildNavItem(int index, IconData icon, String label, BuildContext context) => InkWell(
    onTap: () {
      onItemTapped(index);
      if (index == 0) {
